...
#ifndef PATH_SEARCHING__NODE_HYBRID_HPP_
#define PATH_SEARCHING__NODE_HYBRID_HPP_
...
public:
   ...
   */
  void getNeighbors(
    std::function<bool(const unsigned int &, path_searching::NodeHybrid * &)> & validity_checker,
